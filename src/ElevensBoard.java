...
public class ElevensBoard {
    ...
    private boolean containsPairSum11(List<Integer> selectedCards) {
        for (int i = 0; i < selectedCards.size(); i++) {
            int card1Index = selectedCards.get(i);
            Card card1 = cards[card1Index];
            for (int j = i + 1; j < selectedCards.size(); j++) {
                int card2Index = selectedCards.get(j);
                Card card2 = cards[card2Index];
                if (card1 != null && card2 != null && card1.pointValue() + card2.pointValue() == 11) {
                    return true;
                }
            }
        }
    ...
    private boolean containsJQK(List<Integer> selectedCards) {
        ...
        for (int i = 0; i < selectedCards.size(); i++) {
            Card card = cards[selectedCards.get(i)];
            if (card != null) {
